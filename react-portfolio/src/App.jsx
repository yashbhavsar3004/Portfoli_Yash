      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center px-6">
        <div className="max-w-5xl mx-auto text-center z-10">
          ...
          <div className="flex flex-wrap gap-4 justify-center opacity-0 animate-fadeIn" style={{ animationDelay: '1s', animationFillMode: 'forwards' }}>
            ...
            <button className="px-8 py-4 border border-gray-700 rounded-lg font-medium hover:border-blue-500 hover:bg-blue-500/10 transition-all flex items-center gap-2">
              <Download size={18} />
              Download Resume
            </button>
          </div>
